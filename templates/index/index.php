...
<html lang="es">
  <head>
    ...
    <title>UOC Gestión Alumni</title>
  ...
  <body style="background-image: url('https://www.uoc.edu/portal/_resources/common/imatges/sala_de_premsa/noticies/2018/286-satisfaccio-graduats.jpg');" class="text-center">

    <div class="cover-container d-flex h-100 p-3 mx-auto flex-column">
      <header class="masthead mb-auto">
        <div class="inner">
          <h3 class="masthead-brand">UOC Alumni</h3>
          <nav class="nav nav-masthead justify-content-center">
            <a class="nav-link active" href="login/login.php">Iniciar Sesión</a>
          </nav>
        </div>
      </header>

      <main role="main" class="inner cover">
        <h1 class="cover-heading">Bienvenido a la UOC</h1>
        <p class="lead">
          <a href="login/login.php" class="btn btn-lg btn-secondary">Acceder</a>
        </p>
      </main>

      <footer class="mastfoot mt-auto">
        <div class="inner">
          <p style="color:white; font-size:18px;"><b>Nikola Minchev | Israel Pérez</b></p>
        </div>
      </footer>
    </div>
