...
rounded-lg shadow-lg">
    ...
    <div class="grid grid-rows-3 grid-flow-col gap-4">
        ...
        <div class="row-span-2 col-span-2 ...">
            ...
            <a href="/admin-enrolment/create" class="btn btn-primary">CREAR</a>
            ...
            <table class="table table-dark table-striped mt-4">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="{{ route('enrolmentsController.destroy',$enrollment->id_enrollment) }}" method="POST">
                                <a href="/admin-enrolment/edit/{{$enrollment->id_enrollment}}" class="btn btn-info">Change Status</a>
                                @csrf
                                @method('DELETE')
