...
rounded-lg shadow-lg">
    ...
    <div class="grid grid-rows-3 grid-flow-col gap-4">
        <div class="row-span-3 ...">
            <aside class="w-64" aria-label="Sidebar">
                <div class="overflow-y-auto py-4 px-3 bg-gray-50 rounded dark:bg-gray-800">
                    <ul class="space-y-2">
                        <li>
                            <a href="{{ route('adminCourses.index') }}" class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
        ...
        <div class="col-span-2 ...">
            <h1 class="text-3xl text-center font-bold">Admin</h1>
        </div>
        <div class="row-span-2 col-span-2 ...">0sdffffddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd3</div>
    </div>
